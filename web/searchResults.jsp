        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    <strong>Welcome to USTBTUBE!</strong>
                </div>
                <div class="col-md-6 col-sm-6">
        ...
        <div class="row">
            <div id="main-content" class="col-md-8">
                <c:forEach items="${videoList}" var="v">
                    <article>
                        <a href="#"><h2 class="vid-name">${v.videoTitle}</h2></a>
                        <div class="info">
                            <h5>By <a href="#">${v.userName}</a></h5>
                            <span><i class="fa fa-calendar"></i>${v.createTime}</span>
                            <span><i class="fa fa-comment"></i> ${v.comment} Comments</span>
                            <span><i class="fa fa-heart"></i>${v.star}</span>
